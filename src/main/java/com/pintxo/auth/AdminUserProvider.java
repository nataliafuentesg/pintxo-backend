...
public class AdminUserProvider {
    ...
    public AdminUserProvider(
            @Value("${pintxo.auth.admin.email}") String email,
            @Value("${pintxo.auth.admin.name}") String name,
            @Value("${pintxo.auth.admin.password:}") String pwdPlain,
            @Value("${pintxo.auth.admin.password-hash:}") String pwdHash,
            PasswordEncoder enc) {
